...
class MetrologyServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Metrology';

    protected string $nameLower = 'metrology';
    ...
    protected function registerCommandSchedules(): void
    {
        $this->app->booted(function () {
            ...
            $schedule::command('metrology:check-status')->dailyAt('06:00');
        });
    }
